...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m10(email) => "こんにちは、${email}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountOverview": MessageLookupByLibrary.simpleMessage("アカウント概要"),
    ...
    "dataCollectionContent": MessageLookupByLibrary.simpleMessage(
      "本アプリは第三者のクラッシュ分析や行動追跡を使用しません。診断ログは端末内に保存され、アカウントトークン、クイックログインリンク、購読リンクは除去されます。",
    ),
    ...
    "neverExpires": MessageLookupByLibrary.simpleMessage("無期限"),
    ...
    "openWebsite": MessageLookupByLibrary.simpleMessage("公式サイトを開く"),
    ...
    "planTraffic": MessageLookupByLibrary.simpleMessage("プラン通信量"),
    ...
    "trafficOverview": MessageLookupByLibrary.simpleMessage("通信量の概要"),
    "trafficPackage": MessageLookupByLibrary.simpleMessage("追加通信量"),
    ...
    "unableToOpenPage": MessageLookupByLibrary.simpleMessage("ページを開けません"),
    ...
    "urlTip": m25,
    "useAnotherAccount": MessageLookupByLibrary.simpleMessage("別のアカウントを使用"),
    ...
    "webviewUnavailable": MessageLookupByLibrary.simpleMessage(
      "内蔵ブラウザを利用できないため、システムブラウザで開きました。",
    ),
